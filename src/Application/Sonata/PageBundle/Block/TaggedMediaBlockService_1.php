 ...
 */
class TaggedMediaBlockService extends BaseBlockService
{
     ...
     * @param \Sonata\MediaBundle\Model\MediaManager           $mediaManager
     */
    public function __construct($name, EngineInterface $templating, ContainerInterface $container, MediaManager $mediaManager)
    {
    ...
    {
        return 'ApplicationSonataPageBundle:Block:block_taggedmedia.html.twig';
    }
