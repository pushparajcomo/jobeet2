...
namespace Push\JobeetBundle\DataFixtures\ORM;
...
class LoadJobData extends AbstractFixture implements OrderedFixtureInterface
{
  public function load(ObjectManager $em)
  {
    ...
    $job_sensio_labs->setExpiresAt(new \DateTime('2013-12-10'));
    ...
    $job_extreme_sensio->setExpiresAt(new \DateTime('2013-12-10'));
