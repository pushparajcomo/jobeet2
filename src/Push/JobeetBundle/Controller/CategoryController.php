...
use Push\JobeetBundle\Entity\Category;
   ...
   public function showAction($slug, $page)
{
  ...
  $category = $em->getRepository('PushJobeetBundle:Category')->findOneBySlug($slug);
 
  if (!$category) {
    throw $this->createNotFoundException('Unable to find Category entity.');
  }
 
  $total_jobs = $em->getRepository('PushJobeetBundle:Job')->countActiveJobs($category->getId());
